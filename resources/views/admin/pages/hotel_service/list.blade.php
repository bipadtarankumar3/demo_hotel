        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ isset($service) ? URL::to('admin/hotel/service/edit-action/' . $service->id) : URL::to('admin/hotel/service/add-action') }}" method="post">
                            @csrf
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($services as $key => $service)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ URL::to('admin/hotel/service/edit', $service->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="{{ URL::to('admin/hotel/service/delete', $service->id) }}" onclick="deleteConfirmation(event)"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
